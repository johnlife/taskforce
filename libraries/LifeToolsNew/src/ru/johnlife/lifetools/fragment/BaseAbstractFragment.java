...
public abstract class BaseAbstractFragment extends Fragment implements Constants {
	...
	private static final Finder toolbarFinder = suspect -> suspect instanceof Toolbar;
	...
	public final View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
			...
			if (null != title) {
				...
				if (null != actionBar) {
					...
					coordinator.postDelayed(() -> {
                        ActionBar actionBar1 = baseActivity.getSupportActionBar();
                        if (null != actionBar1) {
                            actionBar1.setTitle(title);
                            actionBar1.setDisplayHomeAsUpEnabled(isUpAsHomeEnabled());
                        }
                    }, 100);
				}
			}
		...
		View mainView = createView(inflater, coordinator, savedInstanceState);
