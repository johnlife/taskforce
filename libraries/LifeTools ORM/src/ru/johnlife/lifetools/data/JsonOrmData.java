...
public class JsonOrmData extends JsonData {
    ...
    public static <T> void addDeserializer(Class<T> clazz, JsonDeserializer<T> deserializer) {
        SimpleModule addon = new SimpleModule();
        addon.addDeserializer(clazz, deserializer);
        mapper.registerModule(addon);
    }
